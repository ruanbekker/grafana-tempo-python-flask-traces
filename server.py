...
class SpanFormatter(logging.Formatter):
    def format(self, record):
        ...
        if trace_id == 0:
            ...
            #record.trace_id = "{trace}".format(trace=trace_id)
            record.trace_id = format_trace_id(trace_id if trace_id else 0)
...
def add_user():
    ...
    with tracer.start_as_current_span("db-entry"):
        ...
        try:
            ...
            app.logger.info("entry has been created in the database")
